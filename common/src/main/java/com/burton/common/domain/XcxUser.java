...
public class XcxUser implements Serializable{
    ...
    @Column(name = "union_id", unique = true, columnDefinition = "VARCHAR(64) CHARACTER SET utf8mb4 NOT NULL COMMENT 'UNIONID'")
    private String unionId;

    @Column(name = "nick_name", columnDefinition = "VARCHAR(64) CHARACTER SET utf8mb4 COMMENT '昵称'")
    private String nickName;

    @Column(name = "gender", columnDefinition = "int(4) NOT NULL DEFAULT 1 COMMENT '性别'")
    private Integer gender;

    @Column(name = "avatarUrl", columnDefinition = "VARCHAR(1024) CHARACTER SET utf8mb4 COMMENT '头像'")
    private String avatarUrl;

    @Column(name = "city", columnDefinition = "VARCHAR(64) COMMENT '城市'")
    private String city;

    @Column(name = "province", columnDefinition = "VARCHAR(64) CHARACTER SET utf8mb4 COMMENT '省份'")
    private String province;

    @Column(name = "country", columnDefinition = "VARCHAR(64) CHARACTER SET utf8mb4 COMMENT '区县'")
